...
import { clientesRestructured, contactosRestructured, vendedoresActivosRestructured } from '../../../../utils/controllers/controllers';
import { HandleChangeClient, cantidad_total_proyecto, item_percent, precio_total_proyecto, restructuredProductsProject, subtotal_proyecto, tota_iva_proyecto } from '../../../../utils/controllers/Proyecto/ProyectoControllers';
          ...
          <div className='column' style={{gap:5}}>
            ...
            </div>
            {
              ...
              <SelectComp
                ...
                HandleChange={(value,record)=>{HandleChangeClient(record,setSelectedClient,setContactSelected,setContactList)}}
              />
          ...
          <div className='column' style={{gap:5}}>
            <span className='form-label' style={clientes.length === 0 ? {color:"#b9b9b9c4"} : {}}>Contacto <span style={clientes.length === 0 ? {color:"#b9b9b9c4"} :{color:"red"}}>*</span></span>
            {
              ...
              <SelectComp
                ...
                HandleChange={(value,record)=>{ setContactSelected(record)}}
              />
        ...
        <div className='form-grid'>
          <div className='column' style={{gap:5}}>
            ...
            <SelectComp
              ...
              options={vendedoresActivosRestructured(subusuarios)}
        ...
        <div className='principal-grid grid-3-columns'>
          <div className='column' style={{gap:5}}>
            ...
            <SelectComp
                ...
                HandleChange={(value,record)=>{ setProyecto({...proyecto,condicion_de_pago:value})}}
            />
          </div>
          <div className='column' style={{gap:5}}>
  ...
  return(
    ...
    <div className='principal-container-column'>
      ...
      <div className='form-grid'>
        ...
        <div className='column' style={{gap:5,display:"flex",alignItems:"center",height:"100%"}}>
          <AddMoreBtn label={'Agregar producto/servicio'} HanldeClick={addProductoServicio}/>
        </div>
      </div>
...
const FourthStep = ({setStep,proyecto,setProyecto,direcPrestacion,productsList,vendedorSelected,selectedClient,contactSelected,setErrorScreen,setLoadingScreen}) => {
  ...
  async function sendData (data,objtArray){
    console.log('comenzando peticion')
...
const NuevoProyecto = ({reference,setClose}) => {
